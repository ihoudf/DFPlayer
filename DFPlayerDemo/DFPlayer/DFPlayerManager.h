...
/**
 ...
 基于播放器具有循环播放的功能，开启该属性，无线广域网（WWAN）网络状态通过代理2返回，可在此代理方法下弹窗提示用户，并根据用户选择，若选择继续播放，将此属性置为NO，同时通过代理方法返回的playerManager对象获得currentAudioModel的audioId，执行df_playerPlayWithAudioId:方法继续播放，详见demo。
 */
